...
export default function Dashboard({
  ...
  const enrolledCourses = useSelector(
    (state: any) => state.enrollments.enrolledCourses
  );
  ...
  const filteredCourses = showAllCourses
    ? courses
    : courses.filter((course) => course.createBy === currentUser.loginId);
  ...
  return (
    <div id="wd-dashboard">
      ...
      {['STUDENT', 'TA'].includes(currentUser.role) && (
        <button
          className="btn btn-primary float-end"
          ...
          >
            <div className="card rounded-3 overflow-hidden">
              <img
                ...
                height={160}
                onError={(e) => {
                  e.currentTarget.src = '/images/courses/cs0000.jpg';
                }}
              />
